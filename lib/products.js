...
module.exports = {
    ...
    GetLowestOfferListingsForSKU: function (config, params, xml, cb) {
        ...
        if (_.has(params, 'ItemCondition') && (params['ItemCondition'] === 'Any' || params['ItemCondition'] === 'New' || params['ItemCondition'] === 'Used' || params['ItemCondition'] === 'Collectible' || params['ItemCondition'] === 'Refurbished' || params['ItemCondition'] === 'Club')) {
            parameters['ItemConditon'] = params['ItemCondition'];
        }
    ...
    GetLowestPricedOffersForSKU: function (config, params, xml, cb) {
        ...
        if ((params['ItemCondition'] === 'Any' || params['ItemCondition'] === 'New' || params['ItemCondition'] === 'Used' || params['ItemCondition'] === 'Collectible' || params['ItemCondition'] === 'Refurbished' || params['ItemCondition'] === 'Club')) {
            parameters['ItemCondition'] = params['ItemCondition'];
        } else {
            cb({
                "Error": "ItemCondition is not valid type."
            }, null);
            return;
        }
        mws.createRequest({
    ...
    GetLowestPricedOffersForASIN: function (config, params, xml, cb) {
        ...
        if ((params['ItemCondition'].toUpperCase() === 'ANY' || params['ItemCondition'].toUpperCase() === 'NEW' || params['ItemCondition'].toUpperCase() === 'USED' || params['ItemCondition'].toUpperCase() === 'COLLECTIBLE' || params['ItemCondition'].toUpperCase() === 'REFURBISHED' || params['ItemCondition'].toUpperCase() === 'CLUB')) {
            parameters['ItemCondition'] = params['ItemCondition'];
        } else {
            cb({
                "Error": "ItemCondition is not valid type."
